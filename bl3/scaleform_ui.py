...
class GFxMoviePlayer(unreal.UObject):
    ...
    def SetVariableValueArray(
        self, MovieClipName: str, MemberName: str, Value: unreal.WrappedArray[ASValue]
    ): ...
    ...
    def SetDisplayTransform(
        self, MovieClipName: str, DisplayTransform: core_uobject.Transform
    ): ...
    def SetDisplayInfo(self, MovieClipName: str, Info: ASDisplayInfo): ...
    def SetColorTransform(
        self, MovieClipName: str, UnrealColorTransform: ASColorTransform
    ): ...
    ...
    def OpenMovie(
        self,
        SwfMovie: SwfMovie,
        ExternalScriptInterface: unreal.UObject,
        RenderToTexture: engine.TextureRenderTarget2D,
        MoviePlayer: GFxMoviePlayer,
        DisplayWithHudOff: bool,
        bRefresh: bool,
    ) -> GFxMoviePlayer: ...
    ...
    def Invoke(
        ...
        MovieClipName: str,
        FunctionName: str,
        Params: unreal.WrappedArray[ASValue],
    ) -> ASValue: ...
    ...
    def GetVisibility(self, MovieClipName: str) -> bool: ...
    def GetView3D(self) -> core_uobject.Transform: ...
    def GetVariableValueArray(
        self, MovieClipName: str, MemberName: str
    ) -> unreal.WrappedArray[ASValue]: ...
    def GetVariableValue(self, MovieClipName: str, MemberName: str) -> ASValue: ...
    def GetScale(self, MovieClipName: str, XScale: float, YScale: float) -> bool: ...
    def GetPosition(self, MovieClipName: str, X: float, Y: float) -> bool: ...
    def GetPerspective3D(self) -> ASPerspectiveTransform: ...
    def GetMovieClip(self, MovieClipName: str) -> GFxObject: ...
    def GetDisplayTransform(self, MovieClipName: str) -> core_uobject.Transform: ...
    def GetDisplayInfo(self, MovieClipName: str) -> ASDisplayInfo: ...
    def GetColorTransform(self, MovieClipName: str) -> ASColorTransform: ...
    def Close(self): ...
...
class GFxObject(unreal.UObject):
    ...
    def SetMemberValueArray(
        self,
        MoviePlayer: GFxMoviePlayer,
        MemberName: str,
        Input: unreal.WrappedArray[ASValue],
    ): ...
    ...
    def Invoke(
        self, FunctionName: str, Params: unreal.WrappedArray[ASValue]
    ) -> ASValue: ...
    ...
    def GetScale(self, XScale: float, YScale: float) -> bool: ...
    def GetPosition(self, X: float, Y: float) -> bool: ...
    def GetMemberValueArray(self, MemberName: str) -> unreal.WrappedArray[ASValue]: ...
    def GetMemberValue(self, MemberName: str) -> ASValue: ...
    def GetDisplayTransform(self) -> core_uobject.Transform: ...
    def GetDisplayInfo(self) -> ASDisplayInfo: ...
    def GetColorTransform(self) -> ASColorTransform: ...
...
class ScaleformBlueprintLibrary(engine.BlueprintFunctionLibrary):
    ...
    def InvokeNoParams(
        self, MoviePlayer: GFxMoviePlayer, FunctionName: str
    ) -> ASValue: ...
    def Invoke(
        self,
        MoviePlayer: GFxMoviePlayer,
    ...
    def GetVariable(
        self, MoviePlayer: GFxMoviePlayer, VariablePath: str
    ) -> GFxObject: ...
    def GetMovieClip(
        self, MoviePlayer: GFxMoviePlayer, MovieClipName: str
    ) -> GFxObject: ...
    def GetMember(self, MoviePlayer: GFxMoviePlayer, MemberName: str) -> GFxObject: ...
    def GetAllGFxMoviePlayerOfClass(
        self,
        WorldContextObject: unreal.UObject,
        FoundGFxMoviePlayer: unreal.WrappedArray[GFxMoviePlayer],
        GFxMoviePlayerClass: unreal.UClass,
        VisibleOnly: bool,
    ): ...
