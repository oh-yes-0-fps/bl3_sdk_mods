...
class FaceFXComponent(engine.ActorComponent):
    ...
    def StopAll(self): ...
    def Stop(self, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def Setup(self, SkelMeshComp: engine.SkeletalMeshComponent, AudioComponent: FaceFXAudioComponent, Asset: FaceFXActor, IsAutoPlaySound: bool, IsDisableMorphTargets: bool, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def Resume(self, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def PlayById(self, Group: str, AnimName: str, SkelMeshComp: engine.SkeletalMeshComponent, Loop: bool, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def Play(self, Animation: FaceFXAnim, SkelMeshComp: engine.SkeletalMeshComponent, Loop: bool, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def Pause(self, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def OnCharacterPlaybackStopped(self, Character: FaceFXCharacter, AnimId: FaceFXAnimId): ...
    def OnCharacterAudioStart(self, Character: FaceFXCharacter, AnimId: FaceFXAnimId, IsAudioStarted: bool, AudioComponentStartedOn: FaceFXAudioComponent): ...
    def JumpToById(self, Position: float, Pause: bool, Group: str, AnimName: str, LoopAnimation: bool, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def JumpTo(self, Position: float, Pause: bool, Animation: FaceFXAnim, LoopAnimation: bool, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def IsPlayingAnimation(self, AnimId: FaceFXAnimId, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def IsPlaying(self, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def IsPaused(self, SkelMeshComp: engine.SkeletalMeshComponent, Caller: unreal.UObject, ReturnValue: bool) -> bool: ...
    def GetFaceFXBlendWeight(self, SkeletalMeshComponent: engine.SkeletalMeshComponent, DeltaTime: float, BlendTime: float, ReturnValue: float) -> float: ...
