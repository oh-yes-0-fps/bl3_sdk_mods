...
class BrainComponent(engine.ActorComponent):
    ...
    def IsRunning(self, ReturnValue: bool) -> bool: ...
...
class AIController(engine.Controller):
    ...
    def UseBlackboard(self, BlackboardAsset: BlackboardData, BlackboardComponent: BlackboardComponent, ReturnValue: bool) -> bool: ...
    def UnclaimTaskResource(self, ResourceClass: unreal.UClass): ...
    def SetMoveBlockDetection(self, bEnable: bool): ...
    def RunBehaviorTree(self, BTAsset: BehaviorTree, ReturnValue: bool) -> bool: ...
    def OnUsingBlackBoard(self, BlackboardComp: BlackboardComponent, BlackboardAsset: BlackboardData): ...
    def OnUnpossess(self, UnpossessedPawn: engine.Pawn): ...
    def OnPossess(self, PossessedPawn: engine.Pawn): ...
    def OnGameplayTaskResourcesClaimed(self, NewlyClaimed: gameplay_tasks.GameplayResourceSet, FreshlyReleased: gameplay_tasks.GameplayResourceSet): ...
    def MoveToLocation(self, Dest: core_uobject.Vector, AcceptanceRadius: float, bStopOnOverlap: bool, bUsePathfinding: bool, bProjectDestinationToNavigation: bool, bCanStrafe: bool, FilterClass: unreal.UClass, bAllowPartialPath: bool, ReturnValue: int) -> int: ...
    def MoveToActor(self, Goal: engine.Actor, AcceptanceRadius: float, bStopOnOverlap: bool, bUsePathfinding: bool, bCanStrafe: bool, FilterClass: unreal.UClass, bAllowPartialPath: bool, ReturnValue: int) -> int: ...
    def K2_SetFocus(self, NewFocus: engine.Actor): ...
    def K2_SetFocalPoint(self, FP: core_uobject.Vector): ...
    def K2_ClearFocus(self): ...
    def HasPartialPath(self, ReturnValue: bool) -> bool: ...
    def GetPathFollowingComponent(self, ReturnValue: PathFollowingComponent) -> PathFollowingComponent: ...
    def GetMoveStatus(self, ReturnValue: int) -> int: ...
    def GetImmediateMoveDestination(self, ReturnValue: core_uobject.Vector) -> core_uobject.Vector: ...
    def GetFocusActor(self, ReturnValue: engine.Actor) -> engine.Actor: ...
    def GetFocalPointOnActor(self, Actor: engine.Actor, ReturnValue: core_uobject.Vector) -> core_uobject.Vector: ...
    def GetFocalPoint(self, ReturnValue: core_uobject.Vector) -> core_uobject.Vector: ...
    def GetAIPerceptionComponent(self, ReturnValue: AIPerceptionComponent) -> AIPerceptionComponent: ...
...
class BehaviorTreeComponent(BrainComponent):
    ...
    def SetDynamicSubtree(self, InjectTag: gameplay_tags.GameplayTag, BehaviorAsset: BehaviorTree): ...
    def GetTagCooldownEndTime(self, CooldownTag: gameplay_tags.GameplayTag, ReturnValue: float) -> float: ...
    def AddCooldownTagDuration(self, CooldownTag: gameplay_tags.GameplayTag, CooldownDuration: float, bAddToExistingDuration: bool): ...
...
class AIBlueprintHelperLibrary(engine.BlueprintFunctionLibrary):
    ...
    def UnlockAIResourcesWithAnimation(self, AnimInstance: engine.AnimInstance, bUnlockMovement: bool, UnlockAILogic: bool): ...
    def SpawnAIFromClass(self, WorldContextObject: unreal.UObject, PawnClass: unreal.UClass, BehaviorTree: BehaviorTree, Location: core_uobject.Vector, Rotation: core_uobject.Rotator, bNoCollisionFail: bool, ReturnValue: engine.Pawn) -> engine.Pawn: ...
    ...
    def SendAIMessage(self, Target: engine.Pawn, MESSAGE: str, MessageSource: unreal.UObject, bSuccess: bool): ...
    def LockAIResourcesWithAnimation(self, AnimInstance: engine.AnimInstance, bLockMovement: bool, LockAILogic: bool): ...
    def IsValidAIRotation(self, Rotation: core_uobject.Rotator, ReturnValue: bool) -> bool: ...
    def IsValidAILocation(self, Location: core_uobject.Vector, ReturnValue: bool) -> bool: ...
    def IsValidAIDirection(self, DirectionVector: core_uobject.Vector, ReturnValue: bool) -> bool: ...
    def GetCurrentPath(self, Controller: engine.Controller, ReturnValue: navigation_system.NavigationPath) -> navigation_system.NavigationPath: ...
    def GetBlackboard(self, Target: engine.Actor, ReturnValue: BlackboardComponent) -> BlackboardComponent: ...
    def GetAIController(self, ControlledActor: engine.Actor, ReturnValue: AIController) -> AIController: ...
    def CreateMoveToProxyObject(self, WorldContextObject: unreal.UObject, Pawn: engine.Pawn, Destination: core_uobject.Vector, TargetActor: engine.Actor, AcceptanceRadius: float, bStopOnOverlap: bool, ReturnValue: AIAsyncTaskBlueprintProxy) -> AIAsyncTaskBlueprintProxy: ...
...
class AIPerceptionComponent(engine.ActorComponent):
    ...
    def GetPerceivedHostileActors(self, OutActors: unreal.WrappedArray[engine.Actor]): ...
    def GetPerceivedActors(self, SenseToUse: unreal.UClass, OutActors: unreal.WrappedArray[engine.Actor]): ...
    def GetKnownPerceivedActors(self, SenseToUse: unreal.UClass, OutActors: unreal.WrappedArray[engine.Actor]): ...
    def GetCurrentlyPerceivedActors(self, SenseToUse: unreal.UClass, OutActors: unreal.WrappedArray[engine.Actor]): ...
    def GetActorsPerception(self, Actor: engine.Actor, Info: ActorPerceptionBlueprintInfo, ReturnValue: bool) -> bool: ...
...
class AIPerceptionSystem(unreal.UObject):
    ...
    def ReportPerceptionEvent(self, WorldContextObject: unreal.UObject, PerceptionEvent: AISenseEvent): ...
    def ReportEvent(self, PerceptionEvent: AISenseEvent): ...
    def RegisterPerceptionStimuliSource(self, WorldContextObject: unreal.UObject, Sense: unreal.UClass, Target: engine.Actor, ReturnValue: bool) -> bool: ...
    def OnPerceptionStimuliSourceEndPlay(self, Actor: engine.Actor, EndPlayReason: int): ...
    def GetSenseClassForStimulus(self, WorldContextObject: unreal.UObject, Stimulus: AIStimulus, ReturnValue: unreal.UClass) -> unreal.UClass: ...
...
class AISense_Blueprint(AISense):
    ...
    def OnUpdate(self, EventsToProcess: unreal.WrappedArray[AISenseEvent], ReturnValue: float) -> float: ...
    def OnListenerUpdated(self, ActorListener: engine.Actor, PerceptionComponent: AIPerceptionComponent): ...
    def OnListenerUnregistered(self, ActorListener: engine.Actor, PerceptionComponent: AIPerceptionComponent): ...
    def OnListenerRegistered(self, ActorListener: engine.Actor, PerceptionComponent: AIPerceptionComponent): ...
    def K2_OnNewPawn(self, NewPawn: engine.Pawn): ...
    def GetAllListenerComponents(self, ListenerComponents: unreal.WrappedArray[AIPerceptionComponent]): ...
    def GetAllListenerActors(self, ListenerActors: unreal.WrappedArray[engine.Actor]): ...


class AISense_Damage(AISense):
    RegisteredEvents: unreal.WrappedArray[AIDamageEvent]
    def ReportDamageEvent(self, WorldContextObject: unreal.UObject, DamagedActor: engine.Actor, Instigator: engine.Actor, DamageAmount: float, EventLocation: core_uobject.Vector, HitLocation: core_uobject.Vector): ...


class AISense_Hearing(AISense):
    NoiseEvents: unreal.WrappedArray[AINoiseEvent]
    SpeedOfSoundSq: float
    def ReportNoiseEvent(self, WorldContextObject: unreal.UObject, NoiseLocation: core_uobject.Vector, Loudness: float, Instigator: engine.Actor, MaxRange: float, Tag: str): ...


class AISense_Prediction(AISense):
    RegisteredEvents: unreal.WrappedArray[AIPredictionEvent]
    def RequestPawnPredictionEvent(self, Requestor: engine.Pawn, PredictedActor: engine.Actor, PredictionTime: float): ...
    def RequestControllerPredictionEvent(self, Requestor: AIController, PredictedActor: engine.Actor, PredictionTime: float): ...
...
class AITask_MoveTo(AITask):
    ...
    def AIMoveTo(self, Controller: AIController, GoalLocation: core_uobject.Vector, GoalActor: engine.Actor, AcceptanceRadius: float, StopOnOverlap: int, AcceptPartialPath: int, bUsePathfinding: bool, bLockAILogic: bool, bUseContinuosGoalTracking: bool, ReturnValue: AITask_MoveTo) -> AITask_MoveTo: ...


class AITask_RunEQS(AITask):

    def RunEQS(self, Controller: AIController, QueryTemplate: EnvQuery, ReturnValue: AITask_RunEQS) -> AITask_RunEQS: ...
...
class BlackboardComponent(engine.ActorComponent):
    ...
    def IsVectorValueSet(self, KeyName: str, ReturnValue: bool) -> bool: ...
    def HasValue(self, KeyName: str, ReturnValue: bool) -> bool: ...
    def GetValueAsVector(self, KeyName: str, ReturnValue: core_uobject.Vector) -> core_uobject.Vector: ...
    def GetValueAsString(self, KeyName: str, ReturnValue: str) -> str: ...
    def GetValueAsRotator(self, KeyName: str, ReturnValue: core_uobject.Rotator) -> core_uobject.Rotator: ...
    def GetValueAsObject(self, KeyName: str, ReturnValue: unreal.UObject) -> unreal.UObject: ...
    def GetValueAsName(self, KeyName: str, ReturnValue: str) -> str: ...
    def GetValueAsInt(self, KeyName: str, ReturnValue: int) -> int: ...
    def GetValueAsFloat(self, KeyName: str, ReturnValue: float) -> float: ...
    def GetValueAsEnum(self, KeyName: str, ReturnValue: int) -> int: ...
    def GetValueAsClass(self, KeyName: str, ReturnValue: unreal.UClass) -> unreal.UClass: ...
    def GetValueAsBool(self, KeyName: str, ReturnValue: bool) -> bool: ...
    def GetRotationFromEntry(self, KeyName: str, ResultRotation: core_uobject.Rotator, ReturnValue: bool) -> bool: ...
    def GetLocationFromEntry(self, KeyName: str, ResultLocation: core_uobject.Vector, ReturnValue: bool) -> bool: ...
    def ClearValue(self, KeyName: str): ...
    def AddRuntimeKey(self, KeyName: str, KeyType: BlackboardKeyType, ReturnValue: int) -> int: ...
...
class BTDecorator_BlueprintBase(BTDecorator):
    ...
    bIsObservingBB: bool
    def ReceiveTickAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn, DeltaSeconds: float): ...
    def ReceiveTick(self, OwnerActor: engine.Actor, DeltaSeconds: float): ...
    def ReceiveObserverDeactivatedAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveObserverDeactivated(self, OwnerActor: engine.Actor): ...
    def ReceiveObserverActivatedAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveObserverActivated(self, OwnerActor: engine.Actor): ...
    def ReceiveExecutionStartAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveExecutionStart(self, OwnerActor: engine.Actor): ...
    def ReceiveExecutionFinishAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn, NodeResult: int): ...
    def ReceiveExecutionFinish(self, OwnerActor: engine.Actor, NodeResult: int): ...
    def PerformConditionCheckAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn, ReturnValue: bool) -> bool: ...
    def PerformConditionCheck(self, OwnerActor: engine.Actor, ReturnValue: bool) -> bool: ...
    def IsDecoratorObserverActive(self, ReturnValue: bool) -> bool: ...
    def IsDecoratorExecutionActive(self, ReturnValue: bool) -> bool: ...
...
class BTFunctionLibrary(engine.BlueprintFunctionLibrary):
    ...
    def SetBlackboardValueAsVector(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: core_uobject.Vector): ...
    def SetBlackboardValueAsString(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: str): ...
    def SetBlackboardValueAsRotator(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: core_uobject.Rotator): ...
    def SetBlackboardValueAsObject(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: unreal.UObject): ...
    def SetBlackboardValueAsName(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: str): ...
    def SetBlackboardValueAsInt(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: int): ...
    def SetBlackboardValueAsFloat(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: float): ...
    def SetBlackboardValueAsEnum(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: int): ...
    def SetBlackboardValueAsClass(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: unreal.UClass): ...
    def SetBlackboardValueAsBool(self, NodeOwner: BTNode, Key: BlackboardKeySelector, Value: bool): ...
    def GetOwnersBlackboard(self, NodeOwner: BTNode, ReturnValue: BlackboardComponent) -> BlackboardComponent: ...
    def GetOwnerComponent(self, NodeOwner: BTNode, ReturnValue: BehaviorTreeComponent) -> BehaviorTreeComponent: ...
    def GetBlackboardValueAsVector(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: core_uobject.Vector) -> core_uobject.Vector: ...
    def GetBlackboardValueAsString(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: str) -> str: ...
    def GetBlackboardValueAsRotator(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: core_uobject.Rotator) -> core_uobject.Rotator: ...
    def GetBlackboardValueAsObject(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: unreal.UObject) -> unreal.UObject: ...
    def GetBlackboardValueAsName(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: str) -> str: ...
    def GetBlackboardValueAsInt(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: int) -> int: ...
    def GetBlackboardValueAsFloat(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: float) -> float: ...
    def GetBlackboardValueAsEnum(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: int) -> int: ...
    def GetBlackboardValueAsClass(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: unreal.UClass) -> unreal.UClass: ...
    def GetBlackboardValueAsBool(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: bool) -> bool: ...
    def GetBlackboardValueAsActor(self, NodeOwner: BTNode, Key: BlackboardKeySelector, ReturnValue: engine.Actor) -> engine.Actor: ...
    def ClearBlackboardValueAsVector(self, NodeOwner: BTNode, Key: BlackboardKeySelector): ...
...
class BTService_BlueprintBase(BTService):
    ...
    def ReceiveTickAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn, DeltaSeconds: float): ...
    def ReceiveTick(self, OwnerActor: engine.Actor, DeltaSeconds: float): ...
    def ReceiveSearchStartAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveSearchStart(self, OwnerActor: engine.Actor): ...
    def ReceiveDeactivationAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveDeactivation(self, OwnerActor: engine.Actor): ...
    def ReceiveActivationAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveActivation(self, OwnerActor: engine.Actor): ...
    def IsServiceActive(self, ReturnValue: bool) -> bool: ...
...
class BTTask_BlueprintBase(BTTaskNode):
    ...
    def ReceiveTickAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn, DeltaSeconds: float): ...
    def ReceiveTick(self, OwnerActor: engine.Actor, DeltaSeconds: float): ...
    def ReceiveExecuteAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveExecute(self, OwnerActor: engine.Actor): ...
    def ReceiveAbortAI(self, OwnerController: AIController, ControlledPawn: engine.Pawn): ...
    def ReceiveAbort(self, OwnerActor: engine.Actor): ...
    def IsTaskExecuting(self, ReturnValue: bool) -> bool: ...
    def IsTaskAborting(self, ReturnValue: bool) -> bool: ...
...
class PathFollowingComponent(engine.ActorComponent):
    ...
    def OnActorBump(self, SelfActor: engine.Actor, OtherActor: engine.Actor, NormalImpulse: core_uobject.Vector, Hit: engine.HitResult): ...
    def GetPathDestination(self, ReturnValue: core_uobject.Vector) -> core_uobject.Vector: ...
    def GetPathActionType(self, ReturnValue: int) -> int: ...
...
class EnvQueryContext_BlueprintBase(EnvQueryContext):
    ...
    def ProvideSingleLocation(self, QuerierObject: unreal.UObject, QuerierActor: engine.Actor, ResultingLocation: core_uobject.Vector): ...
    def ProvideSingleActor(self, QuerierObject: unreal.UObject, QuerierActor: engine.Actor, ResultingActor: engine.Actor): ...
    def ProvideLocationsSet(self, QuerierObject: unreal.UObject, QuerierActor: engine.Actor, ResultingLocationSet: unreal.WrappedArray[core_uobject.Vector]): ...
    def ProvideActorsSet(self, QuerierObject: unreal.UObject, QuerierActor: engine.Actor, ResultingActorsSet: unreal.WrappedArray[engine.Actor]): ...
...
class EnvQueryGenerator_BlueprintBase(EnvQueryGenerator):
    ...
    def GetQuerier(self, ReturnValue: unreal.UObject) -> unreal.UObject: ...
    def DoItemGeneration(self, ContextLocations: unreal.WrappedArray[core_uobject.Vector]): ...
...
class EnvQueryInstanceBlueprintWrapper(unreal.UObject):
    ...
    def GetResultsAsLocations(self, ReturnValue: unreal.WrappedArray[core_uobject.Vector]) -> unreal.WrappedArray[core_uobject.Vector]: ...
    def GetResultsAsActors(self, ReturnValue: unreal.WrappedArray[engine.Actor]) -> unreal.WrappedArray[engine.Actor]: ...
    def GetItemScore(self, ItemIndex: int, ReturnValue: float) -> float: ...
    def EQSQueryDoneSignature__DelegateSignature(self, QueryInstance: EnvQueryInstanceBlueprintWrapper, QueryStatus: int): ...
...
class EnvQueryManager(unreal.UObject):
    ...
    def RunEQSQuery(self, WorldContextObject: unreal.UObject, QueryTemplate: EnvQuery, Querier: unreal.UObject, RunMode: int, WrapperClass: unreal.UClass, ReturnValue: EnvQueryInstanceBlueprintWrapper) -> EnvQueryInstanceBlueprintWrapper: ...
...
class NavLinkProxy(engine.Actor):
    ...
    def ReceiveSmartLinkReached(self, Agent: engine.Actor, Destination: core_uobject.Vector): ...
    def IsSmartLinkEnabled(self, ReturnValue: bool) -> bool: ...
    def HasMovingAgents(self, ReturnValue: bool) -> bool: ...


class NavLocalGridManager(unreal.UObject):

    def SetLocalNavigationGridDensity(self, WorldContextObject: unreal.UObject, CellSize: float, ReturnValue: bool) -> bool: ...
    def RemoveLocalNavigationGrid(self, WorldContextObject: unreal.UObject, GridId: int, bRebuildGrids: bool): ...
    def FindLocalNavigationGridPath(self, WorldContextObject: unreal.UObject, Start: core_uobject.Vector, End: core_uobject.Vector, PathPoints: unreal.WrappedArray[core_uobject.Vector], ReturnValue: bool) -> bool: ...
    def AddLocalNavigationGridForPoints(self, WorldContextObject: unreal.UObject, Locations: unreal.WrappedArray[core_uobject.Vector], Radius2D: int, Height: float, bRebuildGrids: bool, ReturnValue: int) -> int: ...
    def AddLocalNavigationGridForPoint(self, WorldContextObject: unreal.UObject, Location: core_uobject.Vector, Radius2D: int, Height: float, bRebuildGrids: bool, ReturnValue: int) -> int: ...
    def AddLocalNavigationGridForCapsule(self, WorldContextObject: unreal.UObject, Location: core_uobject.Vector, CapsuleRadius: float, CapsuleHalfHeight: float, Radius2D: int, Height: float, bRebuildGrids: bool, ReturnValue: int) -> int: ...
    def AddLocalNavigationGridForBox(self, WorldContextObject: unreal.UObject, Location: core_uobject.Vector, Extent: core_uobject.Vector, Rotation: core_uobject.Rotator, Radius2D: int, Height: float, bRebuildGrids: bool, ReturnValue: int) -> int: ...
...
class PawnAction(unreal.UObject):
    ...
    def GetActionPriority(self, ReturnValue: int) -> int: ...
    def Finish(self, WithResult: int): ...
    def CreateActionInstance(self, WorldContextObject: unreal.UObject, ActionClass: unreal.UClass, ReturnValue: PawnAction) -> PawnAction: ...
...
class PawnActionsComponent(engine.ActorComponent):
    ...
    def K2_PushAction(self, NewAction: PawnAction, Priority: int, Instigator: unreal.UObject, ReturnValue: bool) -> bool: ...
    def K2_PerformAction(self, Pawn: engine.Pawn, Action: PawnAction, Priority: int, ReturnValue: bool) -> bool: ...
    def K2_ForceAbortAction(self, ActionToAbort: PawnAction, ReturnValue: int) -> int: ...
    def K2_AbortAction(self, ActionToAbort: PawnAction, ReturnValue: int) -> int: ...
...
class PawnSensingComponent(engine.ActorComponent):
    ...
    def HearNoiseDelegate__DelegateSignature(self, Instigator: engine.Pawn, Location: core_uobject.Vector, Volume: float): ...
    def GetPeripheralVisionCosine(self, ReturnValue: float) -> float: ...
    def GetPeripheralVisionAngle(self, ReturnValue: float) -> float: ...
