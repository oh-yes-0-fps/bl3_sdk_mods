...
class Vehicle(engine.Pawn):
    ...
    VehicleMovement: Any
    bUnpushable: bool
    OnActorComponentAppliedFromAspectData: Any
    ...
    def GetNumWheelsInAir(self) -> int: ...
    def GetEquipedParts(self) -> unreal.WrappedArray[VehiclePartData]: ...
    def AddVehiclePart(self, CharacterPart: VehiclePartData): ...


class VehicleInventoryBalanceStateComponent(
    gbx_inventory.InventoryBalanceStateComponent
): ...
...
class VehicleBoostComponent(engine.ActorComponent):
    ...
    def RegisterBoostRegenerateEvent(
        self, BoostTarget: float, BoostValueReachedDelegate: Any
    ): ...
    def PauseBoost(self): ...
    def OnRep_IsBoosting(self, bWasBoosting: bool): ...
    def K2_BoostStopped(self): ...
    def K2_BoostStarted(self): ...
    def GetRelativeBoostSpeed(self) -> float: ...
    def GetMaxBoostPoolValue(self) -> float: ...
    def GetCurrentBoostPoolValue(self) -> float: ...
    def GetCurrentBoostChargesCount(self) -> int: ...
    def GetBoostEnabled(self) -> bool: ...
    def GetBoostDirection(self) -> core_uobject.Vector: ...
...
class VehicleDigiThrustComponent(engine.ActorComponent):
    OnDigiThrustStarted: Any
    OnDigiThrustCollision: Any
    OnDigiThrustEnd: Any
    OnDigiThrustEndFinished: Any
...
class VehicleHoverComponent(engine.ActorComponent):
    ...
    def ServerUpdateState(
        ...
        InTargetRotation: core_uobject.Rotator,
    ): ...
...
class VehicleMovementInterface(core_uobject.Interface):
    ...
    def GetDirectionBasedThrottleAndSteer(
        self, StickInput: core_uobject.Vector2D
...
class VehiclePowerSlideComponent(engine.ActorComponent):
    ...
    OnStartPowerSlide: Any
    OnEndPowerSlide: Any
    OnStartPowerSlideBoost: Any
    OnEndPowerSlideBoost: Any
    ...
    def IsPowerSlidePaused(self) -> bool: ...
    def IsInPowerSlideBoost(self) -> bool: ...
    def GetPowerSlideEnabled(self) -> bool: ...
    def GetCurrentBoostRatio(self) -> float: ...
...
class WheeledVehicleMovementComponentNW(
    phys_xvehicles.WheeledVehicleMovementComponent4W
):
    ...
    def IsInAir(self) -> bool: ...
    def GetSagittalBalancingEnabled(self) -> bool: ...
    def GetOversteerFixupEnabled(self) -> bool: ...
    def GetNumWheelsInAir(self) -> int: ...
    def GetLateralToLongitudinalVelocityShiftEnabled(self) -> bool: ...
    def GetDirectionBasedThrottleAndSteer(
        self, StickInput: core_uobject.Vector2D
    ) -> core_uobject.Vector2D: ...
    def GetCustomGravityModifier(self) -> float: ...
    def GetCoronalBalancingEnabled(self) -> bool: ...
    def GetCameraRelativeThrottleAndSteer(
        self,
        StickInput: core_uobject.Vector2D,
        WantedDirAngle: float,
        Mode: EVehicleCameraRelativeDrivingMode,
        AngleToSteeringCurve: engine.CurveFloat,
    ) -> core_uobject.Vector2D: ...
    def GetAerialRotationalDampingEnabled(self) -> bool: ...
    def ApplyAngularVelocityInfluence(
        self,
        DeltaTime: float,
        MaxInfluence: float,
        Pitch: float,
...
class BoostRegenerateEvent:
    BoostTarget: float
    VehicleBoostValueReachedEvent: Any
