...
class GbxLevelSequencePlayer(level_sequence.LevelSequencePlayer):
    ...
    def OnStarted(self): ...
    def IsFinished(self, ReturnValue: bool) -> bool: ...
    def CreateGbxLevelSequencePlayer(self, WorldContextObject: unreal.UObject, LevelSequence: level_sequence.LevelSequence, bPlay: bool, Settings: movie_scene.MovieSceneSequencePlaybackSettings, OutActor: GbxLevelSequenceActor, ReturnValue: GbxLevelSequencePlayer) -> GbxLevelSequencePlayer: ...
...
class GbxLevelSequenceThrottleLibrary(engine.BlueprintFunctionLibrary):
    ...
    def ShouldLimitSequenceGroup(self, InGroup: str, ReturnValue: bool) -> bool: ...
