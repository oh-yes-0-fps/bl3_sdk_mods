...
class Mission(unreal.UObject):
    ...
    def UpdateObjective(self, Objective: MissionObjective, Context: unreal.UObject, Amount: int): ...
    def UnpauseObjectiveChain(self, Objective: MissionObjective): ...
    def ThwartObjectiveAndAdvanceObjectiveSet(self, ObjectiveToThwart: MissionObjective, ObjectiveSet: MissionObjectiveSet, bJumpToSet: bool): ...
    def StopMissionTimer(self): ...
    def StartMissionTimer(self): ...
    def MissionTimerExpired(self): ...
    def MissionRemoteEvent(self, EventName: str, ReturnValue: bool) -> bool: ...
    def MissionNotStarted(self): ...
    def MissionKickoff(self): ...
    def MissionGameModeEvent(self, EventName: str, ReturnValue: bool) -> bool: ...
    ...
    def JumpToObjectiveSet(self, ObjectiveSet: MissionObjectiveSet, bIsBranchingMission: bool): ...
    def GetPausableChainedObjectivesList(self, ObjectivesList: unreal.WrappedArray[MissionObjective]): ...
    def GetObjectivesList(self, ObjectivesList: unreal.WrappedArray[MissionObjective]): ...
    def GetObjectiveSetsList(self, ObjectiveSetsList: unreal.WrappedArray[MissionObjectiveSet]): ...
    def GetMissionRemainingSeconds(self, ReturnValue: int) -> int: ...
    ...
    def ActivateMission(self, InitialObjectiveSet: MissionObjectiveSet, bSetAsTrackedMission: bool): ...
...
class MissionIconComponent(engine.PrimitiveComponent):
    ...
    def SetIconEnabledCondition(self, EnabledCondition: gbx_runtime.GbxCondition, ReturnValue: bool) -> bool: ...
    def SetDisabledState(self, bDisabled: bool): ...
    def OnRep_Enabled(self, bPreviouslyEnabled: bool): ...
    def IsIconEnabled(self, ReturnValue: bool) -> bool: ...
...
class PlayerMissionComponent(engine.ActorComponent):
    ...
    def ClientUpdateActiveObjectiveSet(self, MissionClass: unreal.UClass, ActiveObjectiveSet: MissionObjectiveSet, DormantObjectives: unreal.WrappedArray[MissionObjective]): ...
    def ClientTrackedMissionChanged(self, MissionClass: unreal.UClass): ...
    def ClientObjectiveSetCompleted(self, MissionClass: unreal.UClass, CompletedObjectiveSet: MissionObjectiveSet): ...
    def ClientObjectiveCleared(self, MissionClass: unreal.UClass, ClearedObjective: MissionObjective): ...
    def ClientObjectiveChainUnpaused(self, MissionClass: unreal.UClass, Objective: MissionObjective): ...
    ...
    def ClientMissionTimerChanged(self, MissionClass: unreal.UClass, SecondsToAdd: float): ...
    def ClientMissionRegistered(self, MissionClass: unreal.UClass): ...
    def ClientDormantObjectiveRemoved(self, MissionClass: unreal.UClass, Objective: MissionObjective, bIssueActiveEvent: bool): ...
    def ClientDormantObjectiveAdded(self, MissionClass: unreal.UClass, Objective: MissionObjective): ...
...
class MissionDebugMenu(gbx_ui.GbxDebugMenuSubmenu):
    ...
    def GetObjectiveSetItemsForMission(self, MissionId: str, OutItems: unreal.WrappedArray[gbx_ui.GbxCascadingListItemData]): ...
    def GetMissionWithId(self, MissionId: str, ReturnValue: Mission) -> Mission: ...
    def GetMissionStatus(self, MissionId: str, ReturnValue: int) -> int: ...
    def GetItemsForMissionStatus(self, Status: int, OutItems: unreal.WrappedArray[gbx_ui.GbxCascadingListItemData]): ...
    def GetItemsForMissionGraph(self, OutItems: unreal.WrappedArray[gbx_ui.GbxCascadingListItemData]): ...
...
class MissionFunctionLibrary(engine.BlueprintFunctionLibrary):
    ...
    def UpdateMissionObjectiveRef(self, WorldContextObject: unreal.UObject, ObjectiveRef: MissionObjectiveReference): ...
    ...
    def TrackActiveMission(self, WorldContextObject: unreal.UObject, MissionClass: unreal.UClass): ...
    def SendMissionEventWithContext(self, EventRef: MissionEventReference, WorldContextObject: unreal.UObject, OptionalContext: unreal.UObject): ...
    def SendMissionEvent(self, WorldContextObject: unreal.UObject, EventRef: MissionEventReference, OptionalContext: unreal.UObject): ...
    def JumpToMissionObjectiveSetRef(self, WorldContextObject: unreal.UObject, ObjectiveSetRef: MissionObjectiveSetReference, bIsBranchingMission: bool): ...
    def GetPlotMissionIndex(self, MissionObj: Mission, ReturnValue: int) -> int: ...
    def GetObjectiveSetNameListForMission(self, MissionClass: unreal.UClass, NamesList: unreal.WrappedArray[str]): ...
    def GetObjectiveSetListForMission(self, MissionClass: unreal.UClass, ObjectiveSetList: unreal.WrappedArray[MissionObjectiveSet]): ...
    def GetObjectiveNameListForMission(self, MissionClass: unreal.UClass, NamesList: unreal.WrappedArray[str]): ...
    def GetMissionStatus(self, WorldContextObject: unreal.UObject, MissionClass: unreal.UClass, ReturnValue: int) -> int: ...
    def GetMissionObjectiveStatusRef(self, WorldContextObject: unreal.UObject, ObjectiveRef: MissionObjectiveReference, OptionalContext: unreal.UObject, ReturnValue: int) -> int: ...
    def GetMissionObjectiveSetStatusRef(self, WorldContextObject: unreal.UObject, ObjectiveSetRef: MissionObjectiveSetReference, ReturnValue: int) -> int: ...
    def GetMissionObjectiveCount(self, WorldContextObject: unreal.UObject, ObjectiveRef: MissionObjectiveReference, CurrentObjectiveCount: int, TotalObjectiveCount: int): ...
    def GetMissionLevel(self, MissionObj: Mission, ReturnValue: int) -> int: ...
    def GetMissionClassFromObjectiveReferenceWeak(self, ObjectiveReference: MissionObjectiveReferenceWeak, ReturnValue: unreal.UClass) -> unreal.UClass: ...
    def GetMissionClassFromObjectiveReference(self, ObjectiveReference: MissionObjectiveReference, ReturnValue: unreal.UClass) -> unreal.UClass: ...
    def GetMission(self, WorldContextObject: unreal.UObject, MissionClass: unreal.UClass, ReturnValue: Mission) -> Mission: ...
    def GetEventNameListForMission(self, MissionClass: unreal.UClass, NamesList: unreal.WrappedArray[str]): ...
    def GetCurrentlyTrackedMission(self, WorldContextObject: unreal.UObject, ReturnValue: unreal.UClass) -> unreal.UClass: ...
    def GetActivePlotMission(self, WorldContextObject: unreal.UObject, ReturnValue: unreal.UClass) -> unreal.UClass: ...
    def GetActiveMissions(self, WorldContextObject: unreal.UObject, ReturnValue: unreal.WrappedArray[Mission]) -> unreal.WrappedArray[Mission]: ...
    def FillMissionObjectiveSetRef(self, MissionObjectiveSetRef: MissionObjectiveSetReference, MissionClass: unreal.UClass, ObjectiveSet: str): ...
    def FillMissionObjectiveRefWeak(self, MissionObjectiveRef: MissionObjectiveReferenceWeak, MissionClass: unreal.UClass, Objective: str): ...
    def FillMissionObjectiveRef(self, MissionObjectiveRef: MissionObjectiveReference, MissionClass: unreal.UClass, Objective: str): ...
    def FillMissionEventRef(self, MissionEventRef: MissionEventReference, MissionClass: unreal.UClass, EventName: str): ...
    def EqualEqual_MissionObjectiveSetReference(self, A: MissionObjectiveSetReference, B: MissionObjectiveSetReference, ReturnValue: bool) -> bool: ...
    def EqualEqual_MissionObjectiveReference(self, A: MissionObjectiveReference, B: MissionObjectiveReference, ReturnValue: bool) -> bool: ...
    def DebugJumpToMissionObjectiveSetRef(self, WorldContextObject: unreal.UObject, ObjectiveSetRef: MissionObjectiveSetReference, bIsBranchingMission: bool): ...
    def CreateMission(self, WorldContextObject: unreal.UObject, MissionClass: unreal.UClass, ReturnValue: Mission) -> Mission: ...
    def CompleteMission(self, WorldContextObject: unreal.UObject, MissionClass: unreal.UClass): ...
    def AdvanceToBreadcrumbObjective(self, WorldContextObject: unreal.UObject, BreadcrumbObjectiveRef: MissionObjectiveReference): ...
    def AdvanceMissionObjectiveSetRef(self, WorldContextObject: unreal.UObject, ObjectiveSetRef: MissionObjectiveSetReference): ...
    def ActivateMissionAtObjectiveSet(self, WorldContextObject: unreal.UObject, ObjectiveSetRef: MissionObjectiveSetReference): ...
    def ActivateMission(self, WorldContextObject: unreal.UObject, MissionClass: unreal.UClass): ...
...
class MissionObjectiveReferenceInterface(core_uobject.Interface):
    ...
    def GetMissionObjectiveReferences(self, OutMissionObjectives: unreal.WrappedArray[MissionObjectiveReference]): ...
...
class MissionObjectiveSetReferenceInterface(core_uobject.Interface):
    ...
    def GetMissionObjectiveSetReferences(self, OutMissionObjectiveSets: unreal.WrappedArray[MissionObjectiveSetReference]): ...
...
class MissionObserverComponent(engine.ActorComponent):
    ...
    def GetUpdateEventObject(self, OutMissionInitialized: unreal.WrappedArray[unreal.UObject], OutMissionUpdate: unreal.WrappedArray[unreal.UObject], OutMissionObjectiveUpdate: unreal.WrappedArray[unreal.UObject], OutMissionObjectiveSetUpdate: unreal.WrappedArray[unreal.UObject], ReturnValue: bool) -> bool: ...
...
class MissionReferenceInterface(core_uobject.Interface):
    ...
    def GetMissionClassReferences(self, OutMissions: unreal.WrappedArray[unreal.UClass]): ...
    def CheckForMissionReferenceErrors(self, ReturnValue: bool) -> bool: ...
