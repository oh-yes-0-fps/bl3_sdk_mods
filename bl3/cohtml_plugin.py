...
class CohtmlBaseComponent(engine.ActorComponent):
    ReadyForBindings: Any
    BindingsReleased: Any
    ScriptingReady: Any
    ...
    def IsReadyToCreateView(self) -> bool: ...
    def IsReadyForBindings(self) -> bool: ...
    def HasRequestedView(self) -> bool: ...
    ...
    def CreateJSEvent(self) -> CohtmlJSEvent: ...
    def CreateDataModelFromStruct(
        self, Name: str, Arg: core_uobject.StructProperty
    ): ...
...
class CohtmlBlueprintFunctionLibrary(engine.BlueprintFunctionLibrary):
    ...
    def TriggerJSEvent(
        self, Component: CohtmlBaseComponent, EventName: str, JSEvent: CohtmlJSEvent
    ): ...
    def CreateJSEvent(self, WorldContextObject: unreal.UObject) -> CohtmlJSEvent: ...
    def AddStructArg(
        self, JSEvent: CohtmlJSEvent, Arg: core_uobject.StructProperty
    ): ...
    ...
    def AddArrayOfStructs(
        self, JSEvent: CohtmlJSEvent, Arg: unreal.WrappedArray[int]
    ): ...
    def AddArray(
        self, JSEvent: CohtmlJSEvent, Arg: unreal.WrappedArray[int], ArrayType: int
    ): ...
...
class CohtmlGameHUD(engine.HUD):
    ...
    def SetupView(
        self, PageUrl: str, bEnableComplexCSSSupport: bool, bDelayedUpdate: bool
    ): ...
...
class CohtmlInputActor(engine.Actor):
    OnCohtmlInputActorMouseButtonDown: Any
    OnCohtmlInputActorMouseButtonUp: Any
    OnCohtmlInputActorKeyDown: Any
    OnCohtmlInputActorKeyUp: Any
    ...
    def GetInputPropagationBehaviour(self) -> int: ...
...
class CohtmlWidget(umg.Widget):
    ...
    def IsReadyForBindings(self) -> bool: ...
    def HasRequestedView(self) -> bool: ...
    def GetRenderTexture(self) -> engine.TextureRenderTarget2D: ...
    def GetInputPropagationBehaviour(self) -> int: ...
    def CreateJSEvent(self) -> CohtmlJSEvent: ...
    def CreateDataModelFromStruct(
        self, Name: str, Struct: core_uobject.StructProperty
    ): ...
    def CreateDataModelFromObject(self, Name: str, Model: unreal.UObject): ...
